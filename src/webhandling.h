...
public:
    ...
    void setEnabled(bool enabled) override { 
        ...
        if (_Enabled) {
            ...
            _timer.set(getDelay() * 60000); // Minuten in Millisekunden
            _timer.start();
            Serial.printf("Relay %s disabled, will turn off after %u min\n", getName().c_str(), getDelay());
        }
    }
    ...
    String getEnableTime() const { return String(_TimeValue); }
